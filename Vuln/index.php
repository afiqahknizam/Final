...
function create_tables($conn, $db_name){
   ...
   $sql = 'INSERT INTO users (firstname, lastname, username, password) VALUES ("UniKL","MIIT", "BCSS", "SSD")';
   if (mysqli_query($conn, $sql)) {
   echo "New record created successfully </br>";
   }
   else {
   ...
   $sql = 'INSERT INTO users (firstname, lastname, username, password) VALUES ("Well","Done", "you", "rock")';
   if (mysqli_query($conn, $sql)) {
   echo "New record created successfully </br>";
   }
   else {
